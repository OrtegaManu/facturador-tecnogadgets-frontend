...
export const SEO_PAGES = {
  '/': {
    ...
    heroIntro: 'Crea facturas y proformas en PDF en segundos. Sin registro.',
  ...
  '/generador-de-facturas': {
    ...
    heroIntro: 'Crea una factura en PDF de forma rápida y sin registro.',
  ...
  '/generador-de-proformas': {
    ...
    heroIntro: 'Crea una proforma en PDF de forma rápida y sin registro.',
